...
class OptionsFlow(config_entries.OptionsFlow):
    ...
    def openai_config_option_schema(self, options: MappingProxyType[str, Any]) -> dict:
        ...
        return {
            ...
            vol.Optional(
                CONF_USE_GET_AUTOMATION_TOOL,
                description={"suggested_value": options.get(CONF_USE_GET_AUTOMATION_TOOL, DEFAULT_USE_GET_AUTOMATION_TOOL)},
                default=DEFAULT_USE_GET_AUTOMATION_TOOL,
            ): BooleanSelector(),
            vol.Optional(
                CONF_USE_ADJUST_AUTOMATION_TOOL,
                description={"suggested_value": options.get(CONF_USE_ADJUST_AUTOMATION_TOOL, DEFAULT_USE_ADJUST_AUTOMATION_TOOL)},
                default=DEFAULT_USE_ADJUST_AUTOMATION_TOOL,
            ): BooleanSelector(),
            vol.Optional(
                CONF_ENABLE_CONTINUOUS_CONVERSATION,
